...
import { WorkspaceCardMobile } from "./WorkspaceCardMobile";
...
export function WorkspaceManagement() {
  ...
  }, [workspaces, managingMembersWorkspace]);
        ...
        <CardContent>
          {workspaces.length === 0 ? (
            <div className="text-center py-8">
              <p className="text-muted-foreground mb-4">Você ainda não possui núcleos financeiros.</p>
              <Button onClick={() => setShowCreateModal(true)}>
                <Plus className="mr-2 h-4 w-4" />
                      ...
                      <TableRow key={workspace.id}>
                        ...
                        <TableCell>
                          <div className="flex items-center gap-1">
                            {(workspace.is_owner) && <Crown className="h-3 w-3 text-yellow-500" />}
                            <Badge
                              variant={workspace.is_owner ? "default" : "outline"}
                              className="flex items-center gap-1"
                            >
                              {workspace.is_owner ? "Proprietário" : workspace.user_role === "admin" ? "Administrador" : "Usuário"}
                            </Badge>
                          </div>
                        </TableCell>
                        <TableCell>
                        ...
                        <TableCell>
                          <DropdownMenu>
                            ...
                            <DropdownMenuContent align="end">
                              ...
                              {canDelete(workspace) && (
                                <DropdownMenuItem onClick={() => handleDelete(workspace)} className="text-destructive">
                                ...
                                <AlertDialog>
                                  ...
                                  <AlertDialogContent>
                                    <AlertDialogHeader>
                                      ...
                                      <AlertDialogDescription>
                                        Tem certeza que deseja sair do núcleo "{workspace.name}"? Você perderá acesso a todas as informações financeiras deste núcleo. Para voltar, será necessário ser convidado novamente.
                                      </AlertDialogDescription>
                                    </AlertDialogHeader>
                                    <AlertDialogFooter>
