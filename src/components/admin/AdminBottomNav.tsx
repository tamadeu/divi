...
import { Users, BarChart3, Building2, Menu, Building } from "lucide-react";
  ...
  return (
    <div className="fixed bottom-0 left-0 z-50 w-full h-16 border-t bg-card md:hidden">
      <div className="grid h-full grid-cols-5">
        ...
        <button
          onClick={onMenuClick}
          className="inline-flex flex-col items-center justify-center px-2 text-muted-foreground hover:bg-muted"
        >
